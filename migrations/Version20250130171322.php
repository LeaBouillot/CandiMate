 ...
 */
final class Version20250130171322 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE job_offer DROP application_date, CHANGE app_user_id app_user_id INT NOT NULL, CHANGE title title VARCHAR(180) NOT NULL, CHANGE company company VARCHAR(180) NOT NULL, CHANGE link link VARCHAR(120) DEFAULT NULL, CHANGE location location VARCHAR(255) DEFAULT NULL, CHANGE salary salary VARCHAR(180) DEFAULT NULL, CHANGE contact_person contact_person VARCHAR(120) DEFAULT NULL, CHANGE contact_email contact_email VARCHAR(120) DEFAULT NULL, CHANGE status status VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE job_offer ADD application_date DATE NOT NULL, CHANGE app_user_id app_user_id INT DEFAULT NULL, CHANGE title title VARCHAR(255) NOT NULL, CHANGE company company VARCHAR(150) NOT NULL, CHANGE link link VARCHAR(255) DEFAULT \'NULL\', CHANGE location location VARCHAR(255) DEFAULT \'NULL\', CHANGE salary salary VARCHAR(50) DEFAULT \'NULL\', CHANGE contact_person contact_person VARCHAR(255) DEFAULT \'NULL\', CHANGE contact_email contact_email VARCHAR(255) DEFAULT \'NULL\', CHANGE status status VARCHAR(50) NOT NULL');
