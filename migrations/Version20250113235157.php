 ...
 */
final class Version20250113235157 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE job_offer DROP created_at, DROP updated_at, CHANGE app_user_id app_user_id INT NOT NULL, CHANGE title title VARCHAR(180) NOT NULL, CHANGE company company VARCHAR(180) NOT NULL, CHANGE link link VARCHAR(120) DEFAULT NULL, CHANGE salary salary VARCHAR(180) DEFAULT NULL, CHANGE contact_person contact_person VARCHAR(120) DEFAULT NULL, CHANGE contact_email contact_email VARCHAR(120) DEFAULT NULL, CHANGE status status VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE job_offer ADD CONSTRAINT FK_288A3A4E4A3353D8 FOREIGN KEY (app_user_id) REFERENCES `user` (id)');
        $this->addSql('ALTER TABLE linked_in_message CHANGE job_offer_id job_offer_id INT NOT NULL, CHANGE app_user_id app_user_id INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE user ADD is_verified TINYINT(1) NOT NULL, CHANGE first_name first_name VARCHAR(120) NOT NULL, CHANGE last_name last_name VARCHAR(120) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `user` DROP is_verified, CHANGE first_name first_name VARCHAR(80) NOT NULL, CHANGE last_name last_name VARCHAR(80) NOT NULL');
        ...
        $this->addSql('ALTER TABLE linked_in_message CHANGE job_offer_id job_offer_id INT DEFAULT NULL, CHANGE app_user_id app_user_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE job_offer DROP FOREIGN KEY FK_288A3A4E4A3353D8');
        $this->addSql('ALTER TABLE job_offer ADD created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', ADD updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', CHANGE app_user_id app_user_id INT DEFAULT NULL, CHANGE title title VARCHAR(255) NOT NULL, CHANGE company company VARCHAR(150) NOT NULL, CHANGE link link VARCHAR(255) DEFAULT NULL, CHANGE salary salary VARCHAR(50) DEFAULT NULL, CHANGE contact_person contact_person VARCHAR(255) DEFAULT NULL, CHANGE contact_email contact_email VARCHAR(255) DEFAULT NULL, CHANGE status status VARCHAR(50) NOT NULL');
    }
}
